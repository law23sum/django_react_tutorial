                    ...
                    fields=[
                            ...
                            ('language', models.CharField(
                                choices=[('abap', 'ABAP'), ('abnf', 'ABNF'),
                                         ...
                                         ('coq', 'Coq'), ('cplint', 'cplint'),
                                         ('cpp', 'C++'),
                                         ('cpp-objdump', 'cpp-objdump'),
                                         ('cpsa', 'CPSA'), ('cr', 'Crystal'),
                                         ('crmsh', 'Crmsh'), ('croc', 'Croc'),
                                         ('cryptol', 'Cryptol'),
                                         ('csharp', 'C#'),
                                         ...
                                         ('ebnf', 'EBNF'), ('ec', 'eC'),
                                         ('ecl', 'ECL'), ('eiffel', 'Eiffel'),
                                         ('elixir', 'Elixir'), ('elm', 'Elm'),
                                         ('elpi', 'Elpi'),
                                         ('emacs-lisp', 'EmacsLisp'),
                                         ('email', 'E-mail'), ('erb', 'ERB'),
                                         ...
                                         ('foxpro', 'FoxPro'),
                                         ('freefem', 'Freefem'),
                                         ('fsharp', 'F#'), ('fstar', 'FStar'),
                                         ('func', 'FunC'),
                                         ('futhark', 'Futhark'),
                                         ('gap', 'GAP'),
                                         ('gap-console', 'GAP session'),
                                         ('gas', 'GAS'), ('gcode', 'g-code'),
                                         ('gdscript', 'GDScript'),
                                         ('genshi', 'Genshi'),
                                         ...
                                         ('haskell', 'Haskell'),
                                         ('haxe', 'Haxe'), ('haxeml', 'Hxml'),
                                         ('hexdump', 'Hexdump'),
                                         ('hlsl', 'HLSL'), ('hsail', 'HSAIL'),
                                         ('hspec', 'Hspec'), ('html', 'HTML'),
                                         ...
                                         ('kotlin', 'Kotlin'),
                                         ('kql', 'Kusto'), ('kuin', 'Kuin'),
                                         ('lasso', 'Lasso'), ('ldapconf',
                                                              'LDAP configuration file'),
                                         ('ldif', 'LDIF'), ('lean', 'Lean'),
                                         ('less', 'LessCss'), ('lighttpd',
                                         ...
                                         ('mozpercentpreproc',
                                          'mozpercentpreproc'), ('mql', 'MQL'),
                                         ('mscgen', 'Mscgen'),
                                         ('mupad', 'MuPAD'), ('mxml', 'MXML'),
                                         ('myghty', 'Myghty'),
                                         ...
                                         ('nimrod', 'Nimrod'), ('nit', 'Nit'),
                                         ('nixos', 'Nix'), ('nodejsrepl',
                                                            'Node.js REPL console session'),
                                         ('notmuch', 'Notmuch'),
                                         ('nsis', 'NSIS'), ('numpy', 'NumPy'),
                                         ('nusmv', 'NuSMV'),
                                         ('objdump', 'objdump'),
                                         ...
                                         ('scss', 'SCSS'), ('sed', 'Sed'),
                                         ('sgf', 'SmartGameFormat'),
                                         ('shen', 'Shen'), ('shexc', 'ShExC'),
                                         ('sieve', 'Sieve'),
                                         ('silver', 'Silver'),
                                         ('singularity', 'Singularity'),
                                         ('slash', 'Slash'), ('slim', 'Slim'),
                                         ('slurm', 'Slurm'),
                                         ('smali', 'Smali'),
                                         ('smalltalk', 'Smalltalk'),
                                         ('smarty', 'Smarty'),
                                         ...
                                         ('stan', 'Stan'), ('stata', 'Stata'),
                                         ('supercollider', 'SuperCollider'),
                                         ('swift', 'Swift'), ('swig', 'SWIG'),
                                         ('systemd', 'Systemd'),
                                         ('systemverilog', 'systemverilog'),
                                         ('tads3', 'TADS 3'), ('tal', 'Tal'),
                                         ('tap', 'TAP'), ('tasm', 'TASM'),
                                         ('tcl', 'Tcl'), ('tcsh', 'Tcsh'),
                                         ...
                                         ('terminfo', 'Terminfo'),
                                         ('terraform', 'Terraform'),
                                         ('tex', 'TeX'), ('text', 'Text only'),
                                         ('thrift', 'Thrift'),
                                         ('ti', 'ThingsDB'),
                                         ('tid', 'tiddler'), ('tlb', 'Tl-b'),
                                         ...
                                         ('yang', 'YANG'), ('yara', 'YARA'),
                                         ('zeek', 'Zeek'),
                                         ('zephir', 'Zephir'), ('zig', 'Zig'),
                                         ('zone', 'Zone')], default='python',
                                max_length=100
                                )),
                            ('style', models.CharField(
                                choices=[('abap', 'abap'), ('algol', 'algol'),
                                         ('algol_nu', 'algol_nu'),
                                         ('arduino', 'arduino'),
                                         ('autumn', 'autumn'),
                                         ('borland', 'borland'), ('bw', 'bw'),
                                         ('colorful', 'colorful'),
                                         ('default', 'default'),
                                         ('dracula', 'dracula'),
                                         ('emacs', 'emacs'),
